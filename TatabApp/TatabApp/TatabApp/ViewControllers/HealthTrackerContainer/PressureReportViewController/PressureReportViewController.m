...
-(void)generateReport{
    ...
    [parameterDict setValue:_lbl_WeightValue.text forKey:@"weight"];
    [parameterDict setValue:_lbl_HeightValue.text forKey:@"height"];
    [parameterDict setValue:@"3" forKey:@"report"];
...
-(void)downloadPdf:(NSString *)str{
    ...
    obj.isPayment = false;
    obj.navigationTitle = [Langauge getTextFromTheKey:@"blood_pressor_report"];
